...
export function DeliveryReportModal({ assetID, isOpen, onClose }: DeliveryReportModalProps) {
  ...
  const loadData = async () => {
    try {
      ...
      // Inicializar todos como "NA" por defecto
      ...
      <div className="relative bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b bg-gradient-to-r from-blue-600 to-blue-700">
          <div className="flex items-center gap-3 text-white">
            ...
            <h2 className="text-lg font-semibold">Reporte de Entrega de Equipo</h2>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="space-y-6">
              ...
              {data.childAssets.length > 0 && (
                <div>
                  <h3 className="font-semibold text-gray-700 mb-3">Componentes / Accesorios Incluidos</h3>
                  <div className="space-y-2">
                    {data.childAssets.map((child, idx) => (
                      <div key={idx} className="flex items-center gap-4 px-3 py-2 bg-gray-50 rounded text-sm">
                        ...
                        <span className="text-gray-500">{child.productType}</span>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Describe la condición del equipo al momento de la entrega..."
                />
              </div>
            </div>
          ) : (
